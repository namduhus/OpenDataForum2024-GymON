...
class SoccerService {
  final String apiUrl =
      'http://openAPI.seoul.go.kr:8088/API KEY/xml/ListProgramByPublicSportsFacilitiesService/1/50/축구';

  Future<List<Map<String, String>>> fetchSoccerClasses() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['ListProgramByPublicSportsFacilitiesService']['row'] != null) {
          ...
          List<Map<String, String>> soccerClasses = [];
          ...
          return soccerClasses;
        } else {
          return [];
        }
      } else {
        print("Failed to load soccer classes");
        return [];
      }
    } catch (e) {
      print('Error fetching soccer classes: $e');
      return [];
    }
  }
}
