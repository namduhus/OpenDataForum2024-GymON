...
import 'dart:async';
import 'dart:convert';
import '../service/swimming_service.dart';
        ...
        content: Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text(swimClass['program']!),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("장소: ${swimClass['place']}"),
                    Text("수강료: ${swimClass['fee']}"),
                    Text("대상: ${swimClass['target']}"),
                    Text("시간: ${swimClass['time']}"),
        ...
        children: [
                      ...
                      child: ListTile(
                        ...
                        trailing: facility['rentalAvailable'] == '가능'
                          ...
                          child: Text("장소이용신청"),
                            ...
                            : null,
                        leading: Icon(Icons.pool, color: Colors.blue),
                      ),
                    );
                  },
                ),
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: _showSwimmingClasses,
