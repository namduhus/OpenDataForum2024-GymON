...
import 'dart:async';
import 'dart:convert';
import '../service/soccer_service.dart';
...
// 대중교통 및 기차 추천 여부를 묻는 확인창
        ...
        content: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text(soccerClass['program']!),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("시설명: ${soccerClass['facility']}"),
                    Text("장소: ${soccerClass['place']}"),
                    Text("수강료: ${soccerClass['fee']}"),
                    Text("대상: ${soccerClass['target']}"),
                    Text("시간: ${soccerClass['time']}"),
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text("$programName에 신청하실려면 개인정보 동의가 필요합니다."),
              CheckboxListTile(
  ...
  void _showConfirmationDialog(bool isClassEnrollment) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(isClassEnrollment ? "강좌신청 완료" : "장소신청 완료"),
        ...
        children: [
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: _showSoccerClasses, // 강좌 신청
